 ...
 */
package ao.adnlogico.nuntius.exception;

import ao.adnlogico.nuntius.util.ApiError;
...
public class GenericExceptionAdvice
{
    ...
    {
        //
        final ApiError apiError = new ApiError(HttpStatus.FORBIDDEN, ex.getLocalizedMessage(), "error 12 occurred");
