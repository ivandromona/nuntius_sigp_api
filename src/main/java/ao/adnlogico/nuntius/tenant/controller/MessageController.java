...
import ao.adnlogico.nuntius.tenant.model_assembler.MessageModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.MessageRepository;
...
//    messageService service;
    ...
    public EntityModel<Message> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Message newmessage, @PathVariable Integer id)
    {
