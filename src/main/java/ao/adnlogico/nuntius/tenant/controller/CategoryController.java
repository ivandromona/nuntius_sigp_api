...
import ao.adnlogico.nuntius.tenant.model_assembler.CategoryModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.CategoryRepository;
...
//    CategoryService service;
    ...
    public ResponseEntity<?> update(@RequestBody Category newCategory, @PathVariable Integer id)
    {
