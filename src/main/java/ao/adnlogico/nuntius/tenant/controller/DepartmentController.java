...
import ao.adnlogico.nuntius.tenant.entity.Department;
import ao.adnlogico.nuntius.exception.EntityNotFoundException;
import ao.adnlogico.nuntius.security.RequestAuthorization;
import ao.adnlogico.nuntius.tenant.model_assembler.DepartmentModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.DepartmentRepository;
...
//    departmentService service;
    ...
    public EntityModel<Department> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Department newdepartment, @PathVariable Integer id)
    {
