...
import ao.adnlogico.nuntius.tenant.model_assembler.ProgressModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.ProgressRepository;
...
//    ProgressService service;
    ...
    public EntityModel<Progress> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Progress newprogress, @PathVariable Integer id)
    {
