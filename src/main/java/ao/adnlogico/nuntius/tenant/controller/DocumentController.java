...
import ao.adnlogico.nuntius.tenant.model_assembler.DocumentModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.DocumentRepository;
...
//    documentService service;
    ...
    public EntityModel<Document> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Document newdocument, @PathVariable Integer id)
    {
