...
import ao.adnlogico.nuntius.tenant.model_assembler.RoleTypeModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.RoleTypeRepository;
...
//    roleTypeService service;
    ...
    public EntityModel<RoleType> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody RoleType newroleType, @PathVariable Integer id)
    {
