...
import ao.adnlogico.nuntius.tenant.model_assembler.RoleModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.RoleRepository;
...
//    roleService service;
    ...
    @RequestAuthorization
    @GetMapping("/role/{id}")
    public EntityModel<Role> findById(@PathVariable Integer id)
    {
    ...
    @RequestAuthorization
    @PutMapping("/role/{id}")
    public ResponseEntity<?> update(@RequestBody Role newrole, @PathVariable Integer id)
    {
