...
import ao.adnlogico.nuntius.tenant.repository.PersonRepository;
import ao.adnlogico.nuntius.tenant.model_assembler.PersontModelAssembler;
...
//    personService service;
    ...
    public EntityModel<Person> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Person newPerson, @PathVariable Integer id)
    {
