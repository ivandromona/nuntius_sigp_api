...
import ao.adnlogico.nuntius.tenant.repository.ForwardingRepository;
...
import ao.adnlogico.nuntius.tenant.model_assembler.ForwardingModelAssembler;
...
//    forwardingService service;
    ...
    public EntityModel<Forwarding> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Forwarding newforwarding, @PathVariable Integer id)
    {
