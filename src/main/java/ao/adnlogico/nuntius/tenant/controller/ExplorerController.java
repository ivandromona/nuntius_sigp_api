...
import ao.adnlogico.nuntius.tenant.model_assembler.ExplorerModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.ExplorerRepository;
...
//    explorerService service;
    ...
    public EntityModel<Explorer> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Explorer newexplorer, @PathVariable Integer id)
    {
