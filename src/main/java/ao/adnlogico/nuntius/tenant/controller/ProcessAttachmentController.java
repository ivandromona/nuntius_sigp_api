...
import ao.adnlogico.nuntius.tenant.model_assembler.ProcessAttachmentModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.ProcessAttachmentRepository;
...
//    processAttachmentService service;
    ...
    public EntityModel<ProcessAttachment> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody ProcessAttachment newprocessAttachment, @PathVariable Integer id)
    {
