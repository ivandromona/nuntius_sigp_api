...
import ao.adnlogico.nuntius.tenant.model_assembler.DocTemplateModelAssembler;
import ao.adnlogico.nuntius.tenant.repository.DocTemplateRepository;
...
//    doctemplateService service;
    ...
    public EntityModel<DocTemplate> findById(@PathVariable Integer id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody DocTemplate newDocTemplate, @PathVariable Integer id)
    {
