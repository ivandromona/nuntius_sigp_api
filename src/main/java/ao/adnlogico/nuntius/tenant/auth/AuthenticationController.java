package ao.adnlogico.nuntius.tenant.auth;

import ao.adnlogico.nuntius.constant.UserStatus;
import ao.adnlogico.nuntius.master.config.DBContextHolder;
import ao.adnlogico.nuntius.master.entity.MasterTenant;
import ao.adnlogico.nuntius.master.services.MasterTenantService;
import ao.adnlogico.nuntius.security.UserTenantInformation;
import ao.adnlogico.nuntius.tenant.auth.AuthResponse;
import ao.adnlogico.nuntius.tenant.auth.UserLoginDTO;
import ao.adnlogico.nuntius.util.JwtTokenUtil;
