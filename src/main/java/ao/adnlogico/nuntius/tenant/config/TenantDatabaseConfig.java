package ao.adnlogico.nuntius.tenant.config;

import ao.adnlogico.nuntius.tenant.entity.User;
import ao.adnlogico.nuntius.tenant.repository.UserRepository;
import ao.adnlogico.nuntius.tenant.services.ProcessService;
...
@ComponentScan(basePackages = {"ao.adnlogico.nuntius.tenant.repository", "ao.adnlogico.nuntius.tenant.entity"})
@EnableJpaRepositories(basePackages = {"ao.adnlogico.nuntius.tenant.repository", "ao.adnlogico.nuntius.tenant.services"},
...
//    @Primary
            ...
            @Qualifier("currentTenantIdentifierResolver") CurrentTenantIdentifierResolver tenantResolver)
    {
        ...
        emfBean.setPackagesToScan(new String[]{User.class.getPackage().getName(), UserRepository.class.getPackage().getName(), ProcessService.class.getPackage().getName()});
