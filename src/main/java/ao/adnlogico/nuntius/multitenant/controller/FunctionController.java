...
import ao.adnlogico.nuntius.multitenant.tenant.model_assembler.FunctionModelAssembler;
import ao.adnlogico.nuntius.multitenant.tenant.repository.FunctionRepository;
...
//    functionService service;
    ...
    public EntityModel<Function> findById(@PathVariable Long id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Function newFunction, @PathVariable Long id)
    {
