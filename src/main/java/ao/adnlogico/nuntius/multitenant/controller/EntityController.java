...
import ao.adnlogico.nuntius.multitenant.tenant.model_assembler.EntityModelAssembler;
import ao.adnlogico.nuntius.multitenant.tenant.repository.EntityRepository;
...
//    entitiesService service;
    ...
    public EntityModel<Entities> findById(@PathVariable Long id)
    {
    ...
    public ResponseEntity<?> update(@RequestBody Entities newentities, @PathVariable Long id)
    {
