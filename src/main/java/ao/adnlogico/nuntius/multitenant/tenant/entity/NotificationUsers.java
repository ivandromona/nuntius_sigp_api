...
public class NotificationUsers implements Serializable
{
    ...
    public NotificationUsers(NotificationUsersPK notificationUsersPK)
    {
        this.notificationUsersPK = notificationUsersPK;
    }

    public NotificationUsers(NotificationUsersPK notificationUsersPK, boolean isDismiss)
    {
        this.notificationUsersPK = notificationUsersPK;
        this.isDismiss = isDismiss;
    }

    public NotificationUsers(int fkNotification, int fkUser)
    {
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof NotificationUsers)) {
            return false;
        }
        NotificationUsers other = (NotificationUsers) object;
