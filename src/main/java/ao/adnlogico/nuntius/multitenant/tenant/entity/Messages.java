...
public class Messages implements Serializable
{
    ...
    private Conversations fkConversation;
    ...
    public Messages(Integer id, String content, boolean isReaded, Date sendedAt)
    {
        this.id = id;
    ...
    public Conversations getFkConversation()
    {
        return fkConversation;
    }

    public void setFkConversation(Conversations fkConversation)
    {
