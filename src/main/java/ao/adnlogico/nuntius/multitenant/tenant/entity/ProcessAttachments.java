...
public class ProcessAttachments implements Serializable
{
    ...
    public ProcessAttachments(Integer id)
    {
        this.id = id;
    }

    public ProcessAttachments(Integer id, String name, String description, String fileUrl, String file, Date createdAt)
    {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof ProcessAttachments)) {
            return false;
        }
        ProcessAttachments other = (ProcessAttachments) object;
