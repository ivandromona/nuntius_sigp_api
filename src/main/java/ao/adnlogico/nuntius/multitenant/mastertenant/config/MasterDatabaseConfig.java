package ao.adnlogico.nuntius.multitenant.mastertenant.config;
...
@EnableJpaRepositories(basePackages = {"ao.adnlogico.nuntius.multitenant.mastertenant.entity", "ao.adnlogico.nuntius.multitenant.mastertenant.repository"},
