package ao.adnlogico.nuntius.multitenant.master.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"ao.adnlogico.nuntius.multitenant.master.entity", "ao.adnlogico.nuntius.multitenant.master.repository"},
