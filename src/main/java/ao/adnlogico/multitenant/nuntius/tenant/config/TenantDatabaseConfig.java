...
@ComponentScan(basePackages = {"ao.adnlogico.multitenant.nuntius.tenant", "ao.adnlogico.multitenant.nuntius.mastertenant"})
@EnableJpaRepositories(basePackages = {"ao.adnlogico.multitenant.nuntius.tenant"},
